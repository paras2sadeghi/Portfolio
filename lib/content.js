...
export const projects = [
  {
    id: "flash-pharmacy",
    title: "Flash Pharmacy",
    subtitle: "AI-powered telehealth & e-commerce platform",
    tags: ["Healthcare", "Web App"],
    gradient: "linear-gradient(135deg, #FF9A6C 0%, #FF6B6B 45%, #C74B8B 100%)",
    period: "2025 — Present",
  },
  {
    id: "sadax-studio",
    title: "Sadax Studio",
    subtitle: "SaaS dashboards & conversion-focused UX",
    tags: ["SaaS", "Dashboard Design"],
    gradient: "linear-gradient(135deg, #123B46 0%, #1F6F5C 55%, #2FA98A 100%)",
    period: "2023 — 2024",
  },
  {
    id: "proshot-softwares",
    title: "Proshot Softwares",
    subtitle: "Research-driven product iterations",
    tags: ["Research", "Product Design"],
    gradient: "linear-gradient(135deg, #E8DFCB 0%, #C9A876 55%, #8C6A4E 100%)",
    period: "2021 — 2023",
  },
  {
    id: "sternx",
    title: "SternX",
    subtitle: "Mobile & web interfaces from the ground up",
    tags: ["Mobile", "UI/UX"],
    gradient: "linear-gradient(135deg, #1A1A2E 0%, #33345A 55%, #5C6BC0 100%)",
    period: "2020 — 2022",
  },
];
